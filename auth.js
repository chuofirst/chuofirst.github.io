...
async function initializeFirebase() {
  try {
    ...
    if (initAttempts < maxAttempts) {
      console.log(`再試行中... (${initAttempts}/${maxAttempts})`);
...
async function startAuth() {
  const { onAuthStateChanged, signOut, signInWithPopup } = await import('https://www.gstatic.com/firebasejs/10.7.1/firebase-auth.js');
