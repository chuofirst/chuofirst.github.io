...
const firebaseConfig = {
  apiKey: "AIzaSyAEu-ZkQK6w1cGNSlMvtw3LywZ6qk1RtFs",  // ← 新しいキー入れておく
...
onAuthStateChanged(auth, (user) => {
  ...
  // ここに来るのは「未ログイン」または「ドメインNG」のとき
  showLoginScreen();
});

// ログイン画面表示
function showLoginScreen() {
  document.body.style.display = 'none';  // こちらも確実に非表示
